...
portalGun = Product.create( name: "Portal Gun Real Thing", size: "One Size", color: 'White', quantity: 50, price: 350, varientId: "Acc02", imageUrl: "https://hottopic.scene7.com/is/image/HotTopic/11913474_hi?$pdp_hero_zoom$", category: 'Accessories', description: "You know the worst part about inventing teleportation? Suddenly, you're able to travel the whole galaxy, and the first thing you learn is, you're the last guy to invent teleportation.")
